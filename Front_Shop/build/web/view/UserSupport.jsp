<%-- 
    Document   : UserSupport
    Created on : May 27, 2023, 10:37:28 PM
    Author     : DELL
--%>
...
<html>
    ...
    <link href="../stylesheet/usersupport.css" rel="stylesheet"/>
    <link
    ...
    <body>
        ...
        <div class="context">
            ...
            <h3> 1. Mục đích thu thập và sử dụng thông tin cá nhân</h3>
            ...
            <p>   FRONT STUDIO cam kết bảo mật mọi thông tin của khách hàng khi gửi thông tin cá nhân tới FRONT STUDIO.</p>
 
            <p>Tất cả các thông tin cá nhân liên quan khách hàng gửi tới cho chúng tôi, chỉ sử dụng cho mục đích liên lạc và trao đổi trực tiếp với quý khách trong thời gian phát sinh đơn hàng tại fornt.vn.</p>
 
            <p>Chúng tôi cam kết không trao đổi mua bán thông tin khách hàng vì mục đích thương mại.</p>
 
            <p>Chính sách bảo vệ thông tin người tiêu dùng chỉ áp dụng những thông tin mà quý khách hàng gửi thông tin trên website chính thức front.vn của chúng tôi. Mọi thông tin quý khách đăng ký tại những website hoặc những địa chỉ khác đều không thuộc phạm vi hiệu lực của chính sách bảo vệ thông tin người tiêu dùng này.</p>
            ...
            <p>Không sử dụng thông tin cá nhân của khách hàng ngoài mục đích xác nhận và liên hệ khi khách hàng có nhu cầu mua sản phẩm của chúng tôi.</p>
 
            <h3>3. Thời gian lưu trữ thông tin:</h3>
            <p> Thông tin khách hàng được lưu trữ tại hệ thống của FRONT STUDIO tối thiểu là 12 tháng, nếu trong vòng 12 tháng khách hàng không phát sinh giao dịch mới thì FRONT STUDIO sẽ xóa các thông tin khách hàng.</p>
            ...
            <h3>5. Địa chỉ của đơn vị thu thập và quản lý thông tin, bao gồm cách thức liên lạc để người tiêu dùng có thể hỏi về hoạt động thu thập, xử lý thông tin liên quan đến cá nhân mình</h3>    
 
            <p>CÔNG TY TNHH SẢN XUẤT VÀ KINH DOANH THƯƠNG MẠI GNC</p>
 
            <p>Địa chỉ : Đại học FPT, Hà Nội</p>
 
            <p>Hotline : 01234567892</p>
 
            <p>Nhận góp ý Gmail : dodvhe161048@fpt.edu.vn</p>
 
            <h3>6. Phương thức và công cụ để người tiêu dùng tiếp cận và chỉnh sửa dữ liệu cá nhân của mình trên hệ thống thương mại điện tử của đơn vị thu thập thông tin</h3>
            ...
            <h3>7. Luật áp dụng khi xảy ra tranh chấp:</h3>
 
            <p>Mọi tranh chấp xảy ra giữa Khách hàng và front.vn sẽ được hòa giải. Nếu hòa giải không thành sẽ được giải quyết tại Tòa án có thẩm quyền và tuân theo pháp luật Việt Nam.</p>
 
            <h3>8. Cơ chế tiếp nhận và giải quyết khiếu nại liên quan đến việc thông tin cá nhân khách hàng:</h3>
